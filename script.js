...
got.houses.forEach((house)=>{
    ...
    let spaceEven = document.createElement("div");
    spaceEven.style.display = "flex";
    spaceEven.style.justifyContent = "space-evenly"
    spaceEven.style.alignItems = "center"
    ...
    spaceEven.append(img,h2);
    box.append(spaceEven,p,btn);
    root.append(box);
    })
})
